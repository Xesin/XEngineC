========================================================================
    APLICACIÓN DE WIN32: Engine Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Engine.
...
Engine.ico
    Éste es un archivo de icono, que se utiliza como el icono de la aplicación (32x32). Este icono está incluido en el archivo principal de recursos Engine.rc.

small.ico
    Este es un archivo de icono, que contiene una versión menor (16x16) del icono de la aplicación. Este icono está incluido en el archivo principal de recursos Engine.rc.
